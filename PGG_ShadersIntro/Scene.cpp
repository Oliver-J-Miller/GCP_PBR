...
void Scene::Update(float deltaTs)
{
	...
	//rotation of the light orbiting the object
	float cubeOrbitMod = 2.0f;
	float cubeOrbit = cubeOrbitMod * deltaTs;
	_modelMatrixCube2 = glm::translate(_modelMatrixCube2, glm::vec3(-10, 0, 0));
	_modelMatrixCube2 = glm::rotate(_modelMatrixCube2,cubeOrbit, glm::vec3(0,-1,0));
	_modelMatrixCube2 = glm::translate(_modelMatrixCube2, glm::vec3(10, 0, 0));
...
void Scene::Draw()
{
	...
	glUseProgram( _shaderProgram );
		...
		/* Draw Cube 1 */
			...
			glUniform1f(_shaderMetalnessLocation, _cube1Metalness);
...
void Scene::BuildShaders()
{
	...
	_shaderMetalnessLocation = glGetUniformLocation(_shaderProgram, "metalness");
