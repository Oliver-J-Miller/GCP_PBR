...
int main(int argc, char *argv[])
{
	...
	while( go )
	{
		...
		if (showLightingWindow)
		{
			...
			//set metallness of the cube
			float metalness = myScene.GetMetalness();
			ImGui::SliderFloat("Metalness", &metalness, 0.0f, 2.0f * 3.141592653589793238462643383);
			myScene.SetMetalness(metalness);
